...
class Main {
	...
	public static void customCode() {
		...
		//Word testString = new Word("(x+0)*1");
    ...
    boolean test = parser.isInLanguage(cfg, testString);
    System.out.println(test);

    // print the parse tree generated
    ParseTreeNode tree = parser.generateParseTree(cfg, testString); 
    tree.print();
